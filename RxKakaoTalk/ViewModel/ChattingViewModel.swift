...
class ChattingViewModel:ViewModelType{
    ...
    lazy var dummyList = [Message(sender: "송정훈", content:testMsg , receiver: "\(friend.profileNickname)", timeStamp: "2021.1.8"),Message(sender: "송정훈", content: "ㅇㅇ", receiver: "\(friend.profileNickname)", timeStamp: "2021.1.8"),Message(sender: "\(friend.profileNickname)", content: testMsg, receiver: "\(friend.profileNickname)", timeStamp: "2021.1.8")]
