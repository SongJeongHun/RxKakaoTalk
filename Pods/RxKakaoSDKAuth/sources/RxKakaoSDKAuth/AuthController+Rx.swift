...
//extension AuthController {
    ...
    /// :nodoc:
    public func authorizeWithAuthenticationSession(authType: AuthType? = nil) -> Observable<OAuthToken> {
    ...
    func authorizeWithAuthenticationSession(authType: AuthType? = nil,
        ...
        return Observable<String>.create { observer in
            ...
            var parameters = authController.makeParameters(authType: authType,
                                                           agtToken: agtToken,
                                                           scopes: scopes,
                                                           channelPublicIds: channelPublicIds,
                                                           serviceTerms: serviceTerms)
