...
extension Reactive where Base: AuthApi {
    ...
    public func loginWithKakaoAccount(authType: AuthType? = nil) -> Observable<OAuthToken> {
        return AuthController.shared.rx.authorizeWithAuthenticationSession(authType: authType)
    }
